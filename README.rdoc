...
* Issue tracking: http://github.com/britt/gem-manage-sources/issues
* Code Metrics: http://getcaliper.com/caliper/project?repo=git://github.com/britt/gem-manage-sources.git
